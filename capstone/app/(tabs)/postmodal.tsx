...
interface PostModalProps {
  ...
  visible: boolean; // Define the visible prop
}

const PostModal: React.FC<PostModalProps> = ({ closeModal, visible }) => {
  return (
    
    <Modal
      animationType="slide"
      transparent={true}
      visible={visible} // You can manage this state in the parent component
