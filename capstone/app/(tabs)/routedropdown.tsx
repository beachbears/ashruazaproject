...
const styles = StyleSheet.create({
  ...
  bestwaycard: {backgroundColor: '#FFFFFF',borderColor: '#E5E7EB',borderWidth: 1,borderRadius: 8,padding: 16,elevation: 4, boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.2)", marginBottom: 28,},
  ...
  floatingButton: {position: 'relative', width: 40, height: 40, borderRadius: 28, backgroundColor: '#6366f1', alignItems: 'center', justifyContent: 'center', boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.2)",elevation: 6, marginTop: 30,},
  ...
  containerpost: { borderRadius: 10, backgroundColor: '#FFFFFF', borderColor: '#EEF2FF', padding: 12, elevation: 4, marginBottom: 20, width: '100%',},
