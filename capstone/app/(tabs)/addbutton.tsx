...
return (
  <ScrollView style={styles.maincontainer}>
      ...
      <View style={[{ borderWidth: 1, borderColor: '#C7D2FE', backgroundColor: '#EEF2FF', borderRadius: 8, padding: 10, flexDirection: 'column', width: '100%', marginTop: 20, height: '10%' }]}>
          <Text>MAP</Text>
      </View>
   ...
   >
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginBottom: 90 }}>
          <TouchableOpacity
              style={{
...
const styles = StyleSheet.create({
  ...
  firsttext: {
   ...
   secondtext: {
    ...
    feedbackcontainer: { flexDirection: 'column', backgroundColor: '#F9FAFB', width: '100%', flex:1, borderWidth: 1, },
    feedback: {flexDirection: 'column'},
    feedbackbox: {borderWidth: 1, borderColor: '#C7D2FE', backgroundColor: '#FBFCFF', borderRadius: 8, padding:4, width: '100%', marginVertical: 4},  
